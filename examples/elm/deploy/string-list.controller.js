...
var Elm = {};
Elm['StringListController'] = Elm['StringListController'] || {};
if (typeof _user$project$StringListController$main !== 'undefined') {
    _user$project$StringListController$main(Elm['StringListController'], 'StringListController', undefined);
}
