...
var Elm = {};
Elm['TodoController'] = Elm['TodoController'] || {};
if (typeof _user$project$TodoController$main !== 'undefined') {
    _user$project$TodoController$main(Elm['TodoController'], 'TodoController', undefined);
}
